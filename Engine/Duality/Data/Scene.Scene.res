<root dataType="Struct" type="Duality.Resources.Scene" id="129723834">
  ...
  <serializeObj dataType="Array" type="Duality.GameObject[]" id="427169525">
    ...
    <item dataType="Struct" type="Duality.GameObject" id="3301912879">
      ...
      <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="3138277837">
        <_items dataType="Array" type="Duality.GameObject[]" id="1401643558" length="4">
                ...
                <item dataType="Struct" type="Duality.Plugins.Tilemaps.Tilemap" id="1937470651">
                  ...
                  <tileData dataType="Struct" type="Duality.Plugins.Tilemaps.TilemapData" id="3980648495" custom="true">
                    <body>
                      ...
                      <data dataType="Array" type="System.Byte[]" id="88321774">H4sIAAAAAAAEAO3BAQ0AAAzDoIqYf6338QCrFgAA/Hbgzgmz+AoAAA==</data>
                    </body>
                  </tileData>
          ...
          <item dataType="Struct" type="Duality.GameObject" id="1480623767">
            <active dataType="Bool">true</active>
            <children />
            <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="487296151">
              <_items dataType="Array" type="Duality.Component[]" id="3885772046" length="4">
                <item dataType="Struct" type="Duality.Components.Transform" id="3840938699">
                  <active dataType="Bool">true</active>
                  <angle dataType="Float">0</angle>
                  <angleAbs dataType="Float">0</angleAbs>
                  <angleVel dataType="Float">0</angleVel>
                  <angleVelAbs dataType="Float">0</angleVelAbs>
                  <deriveAngle dataType="Bool">true</deriveAngle>
                  <gameobj dataType="ObjectRef">1480623767</gameobj>
                  <ignoreParent dataType="Bool">false</ignoreParent>
                  <parentTransform dataType="ObjectRef">1367260515</parentTransform>
                  <pos dataType="Struct" type="Duality.Vector3" />
                  <posAbs dataType="Struct" type="Duality.Vector3" />
                  <scale dataType="Float">1</scale>
                  <scaleAbs dataType="Float">1</scaleAbs>
                ...
                <item dataType="Struct" type="Duality.Plugins.Tilemaps.Tilemap" id="3482475784">
                  <active dataType="Bool">true</active>
                  <gameobj dataType="ObjectRef">1480623767</gameobj>
                  <tileData dataType="Struct" type="Duality.Plugins.Tilemaps.TilemapData" id="345031380" custom="true">
                    <body>
                      <version dataType="Int">3</version>
                      <data dataType="Array" type="System.Byte[]" id="669888228">H4sIAAAAAAAEAO3BAQ0AAAzDoIqYf6338QCrFgAA/Hbgzgmz+AoAAA==</data>
                    </body>
                  </tileData>
                  <tileset dataType="Struct" type="Duality.ContentRef`1[[Duality.Plugins.Tilemaps.Tileset]]">
                    <contentPath dataType="String">Data\Dev\Images\PiecesTiles.Tileset.res</contentPath>
                ...
                <item dataType="Struct" type="Duality.Plugins.Tilemaps.TilemapRenderer" id="178731919">
                  <active dataType="Bool">true</active>
                  <colorTint dataType="Struct" type="Duality.Drawing.ColorRgba">
                    <A dataType="Byte">255</A>
                    <B dataType="Byte">255</B>
            ...
            <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="364221120" surrogate="true">
              <header />
              <body>
                <keys dataType="Array" type="System.Object[]" id="2364393501">
                  <item dataType="ObjectRef">3427459574</item>
                  <item dataType="ObjectRef">3965049156</item>
                  <item dataType="ObjectRef">1921663638</item>
                </keys>
                <values dataType="Array" type="System.Object[]" id="199501560">
                  <item dataType="ObjectRef">3840938699</item>
                  <item dataType="ObjectRef">3482475784</item>
                  <item dataType="ObjectRef">178731919</item>
                </values>
              </body>
            </compMap>
            <compTransform dataType="ObjectRef">3840938699</compTransform>
            <identifier dataType="Struct" type="System.Guid" surrogate="true">
              <header>
                <data dataType="Array" type="System.Byte[]" id="2414437559">hc7vr6+zSUi2/US25JeYWw==</data>
              </header>
              <body />
            </identifier>
            <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
          ...
          <item dataType="Struct" type="Duality.GameObject" id="1319141405">
            <active dataType="Bool">true</active>
            <children />
            <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="2012812429">
              <_items dataType="Array" type="Duality.Component[]" id="2181214502" length="4">
                <item dataType="Struct" type="Duality.Components.Transform" id="3679456337">
                  <active dataType="Bool">true</active>
                  <angle dataType="Float">0</angle>
                  <angleAbs dataType="Float">0</angleAbs>
                  <angleVel dataType="Float">0</angleVel>
                  <angleVelAbs dataType="Float">0</angleVelAbs>
                  <deriveAngle dataType="Bool">true</deriveAngle>
                  <gameobj dataType="ObjectRef">1319141405</gameobj>
                  <ignoreParent dataType="Bool">false</ignoreParent>
                  <parentTransform dataType="ObjectRef">1367260515</parentTransform>
                  <pos dataType="Struct" type="Duality.Vector3" />
                  <posAbs dataType="Struct" type="Duality.Vector3" />
                ...
                <item dataType="Struct" type="Duality.Plugins.Tilemaps.Tilemap" id="3320993422">
                  <active dataType="Bool">true</active>
                  <gameobj dataType="ObjectRef">1319141405</gameobj>
                  <tileData dataType="Struct" type="Duality.Plugins.Tilemaps.TilemapData" id="295278738" custom="true">
                    <body>
                      <version dataType="Int">3</version>
                      <data dataType="Array" type="System.Byte[]" id="384078928">H4sIAAAAAAAEABNhYGAQYUAH+owDSQ0sGExOGnXLqFtG3TLqllG3jLpl1C2jbhkWbhkUFAD0HVmM+AoAAA==</data>
                    </body>
                  </tileData>
                  <tileset dataType="Struct" type="Duality.ContentRef`1[[Duality.Plugins.Tilemaps.Tileset]]">
                    <contentPath dataType="String">Data\Dev\Images\PiecesTiles.Tileset.res</contentPath>
                ...
                <item dataType="Struct" type="Duality.Plugins.Tilemaps.TilemapRenderer" id="17249557">
                  <active dataType="Bool">true</active>
                  <colorTint dataType="Struct" type="Duality.Drawing.ColorRgba">
                    <A dataType="Byte">255</A>
                    <B dataType="Byte">255</B>
            ...
            <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="946616248" surrogate="true">
              <header />
              <body>
                <keys dataType="Array" type="System.Object[]" id="1506636263">
                  <item dataType="ObjectRef">3427459574</item>
                  <item dataType="ObjectRef">3965049156</item>
                  <item dataType="ObjectRef">1921663638</item>
                </keys>
                <values dataType="Array" type="System.Object[]" id="3125318528">
                  <item dataType="ObjectRef">3679456337</item>
                  <item dataType="ObjectRef">3320993422</item>
                  <item dataType="ObjectRef">17249557</item>
                </values>
              </body>
            </compMap>
            <compTransform dataType="ObjectRef">3679456337</compTransform>
            <identifier dataType="Struct" type="System.Guid" surrogate="true">
              <header>
                <data dataType="Array" type="System.Byte[]" id="2323525541">JsrlykXexEqFiFoALd+K/w==</data>
              </header>
              <body />
            </identifier>
            <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
    ...
    <item dataType="ObjectRef">1319141405</item>
    <item dataType="ObjectRef">1480623767</item>
